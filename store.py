...
class Variables(object):
    ...
    def __init__(self): # self means the created object instance
        ...
        self.diff_term = [] # Longkang added for stroring the diffusion term
        self.chem_term = [] # Longkang added for stroring the chemical term
        ...
        if vulcan_cfg.use_sflux_top == True:  # Longkang added
            sflux_data = np.genfromtxt(vulcan_cfg.sflux_top_path, dtype=float, skip_header=1, names=['lambda', 'flux'])
        else:
